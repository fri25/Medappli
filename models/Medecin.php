...
class Medecin extends User {
    ...
    public function register() {
        ...
        $query = "INSERT INTO " . $this->table_name . " 
                  (nom, prenom, datenais, email, contact, password, role, num, idspecialite, 
                   verification_status) 
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bindParam(9, $this->idspecialite);
        ...
        try {
            ...
            if (strpos($e->getMessage(), "Field 'id' doesn't have a default value") !== false) {
                ...
                $query = "INSERT INTO " . $this->table_name . " 
                          (id, nom, prenom, datenais, email, contact, password, role, num, idspecialite, 
                           verification_status) 
                          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
