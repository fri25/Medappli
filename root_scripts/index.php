...
header("Content-Security-Policy: default-src 'self'; script-src 'self' https://cdn.tailwindcss.com https://code.jquery.com https://cdnjs.cloudflare.com https://unpkg.com; style-src 'self' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://unpkg.com 'unsafe-inline'; font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com; img-src 'self' https: data:;");

// Par défaut, masquer les erreurs avant chargement de la configuration
...
try {
    ...
    ini_set('display_errors', env('APP_ENV', 'development') === 'development' ? 1 : 0);
            ...
            <div class="container mx-auto px-6 flex flex-col-reverse lg:flex-row items-center justify-between">
                ...
                <div class="lg:w-1/2 text-center lg:text-left" data-aos="fade-right">
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0 justify-center lg:justify-start">
                        ...
                        <a href="<?php echo app_url('views/register_medecin.php'); ?>" class="text-[#22c55e] border border-[#22c55e] px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#dcfce7] transition">
                            Connectez-vous
                        </a>
                    </div>
                </div>
